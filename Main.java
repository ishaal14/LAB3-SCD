...
public class Main {
    public static void main(String[] args) {
        // Creating Customer
        Customer customer = new Customer("C001", "Alice", "123 Maple St", 1234567890, 28);
        customer.addDetails();

        // Creating Agent
        Agent agent = new Agent(101, "John");

        // Creating BookingCounter
        BookingCounter bookingCounter = new BookingCounter();

        // Creating Ticket
        Ticket ticket = new Ticket("City A", "City B", "2024-11-20", "10:00 AM", "Bus101", "A1");
